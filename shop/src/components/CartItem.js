...
//           <div
//             key={item._id}
//             className="flex items-center justify-between gap-6 my-6 bg-white rounded-lg shadow-lg p-6 sm:flex sm:justify-start"
//           >
            ...
            <div className="w-52 flex items-center justify-between border text-gray-500 gap-4 p-3 rounded-lg shadow-lg">
              ...
              <div className="flex items-center gap-4 text-sm font-semibold">
                <span
                  ...
                  // className="h-5 px-2 font-normal text-xl flex items-center justify-center hover:bg-gray-700 hover:text-white cursor-pointer duration-300 active:bg-black"
                  className="h-5 px-2 font-normal text-xl flex items-center justify-center active:text-2xl cursor-pointer duration-500"
                >
                  -
                </span>
